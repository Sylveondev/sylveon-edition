...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'house': //Clint week
				var bg:BGSprite = new BGSprite('housebg', -600, -200, 0.9, 0.9);
				add(bg);
				var stageFront:BGSprite = new BGSprite('houseroad', -650, 600, 0.9, 0.9);
				stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
				stageFront.updateHitbox();
				add(stageFront);

			case 'treehouse'|'treehouseb': //Squad week
